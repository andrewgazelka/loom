...
let
  ...
  host = rustPlatform.buildRustPackage {
    ...
    meta = { description = "Loom actor host"; license = lib.licenses.mit; mainProgram = "loomd"; };
  };
  ...
  package = pkgs.stdenvNoCC.mkDerivation {
    ...
    meta = { description = "Loom with TypeScript and Rust guest toolchains"; license = lib.licenses.mit; mainProgram = "loom"; };
  };
in { default = package; inherit host toolchain sources; }
