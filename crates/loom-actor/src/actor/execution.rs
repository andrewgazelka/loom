...
pub(crate) async fn attempt(
    ...
    // View-actor bookkeeping rides the message transaction: a schema change marks a pending CDC base,
    // and the message's inbox key becomes the origin of this transaction's CDC rows (docs/ui-view-actor.md).
